...
export default function RecruiterLogin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await recruiterAuthApi.login(email, password);
      ...
      >
        ...
        >
          ...
          >
            ...
            <Link to="/recruiter/register" className="text-primary-600 dark:text-primary-400 hover:underline font-medium">
              Register
            </Link>
          </motion.p>
        </motion.div>
